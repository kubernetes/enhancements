...
1. If a single union member is set and the discriminator is deducible,
set the discriminator to match the member, then
1. If the discriminator is a non-nil/non-empty value, clear union fields
that don't match the discriminator.
