...
| Scenario | New object                       | Existing object                  | Result                                                                                                                                   |
|----------|----------------------------------|----------------------------------|------------------------------------------------------------------------------------------------------------------------------------------|
| B1       | `a: {...}, b: {...}`             | empty                            | `a: {...}, b: {...}`<br>(more than one field added, fail in validation with multiple set)                                                |
| B2       | `a: {...}, b: {...}`             | `a: {...}`                       | `discriminator: B`<br>`b:{...}`<br>(one field added, drop other fields, pass validation)                                                 |
| B3       | `a: {...}, b: {...}`             | `discriminator: A`<br>`a: {...}` | `discriminator: B`<br>`b:{...}`<br>(one field added, drop other fields, pass validation)                                                 |
| B4       | `a: {...}, b: {...}`             | `discriminator: B`<br>`b: {...}` | `discriminator: A`<br>`a:{...}`<br>(one field added, drop other fields, pass validation)                                                 |
| B5       | `discriminator: A`<br>`b: {...}` | empty                            | `discriminator: A`<br>`b:{...}`<br>(discriminator changed and different field added, fail in validation)                                 |
| B6       | `discriminator: A`<br>`b: {...}` | `a: {...}`                       | `discriminator: A`<br>`b:{...}`<br>(discriminator changed and different field added, fail in validation)                                 |
| B7       | `discriminator: A`<br>`b: {...}` | `discriminator: A`<br>`a: {...}` | `discriminator: B`<br>`b:{...}`<br>(discriminator unchanged, one field added, drop other fields, autoset descriminator, pass validation) |
| B8       | `discriminator: B`<br>`a: {...}` | empty                            | `discriminator: B`<br>`a:{...}`<br>(discriminator changed and different field added, fail in validation)                                 |
| B9       | `discriminator: B`<br>`a: {...}` | `a: {...}`                       | `discriminator: B`<br>`a:{...}`<br>(discriminator changed, clear other fields, fail in validation for missing `b`)                       |
| B10      | `discriminator: B`<br>`a: {...}` | `discriminator: A`<br>`a: {...}` | `discriminator: B`<br>`a:{...}`<br>(discriminator changed, clear other fields, fail in validation for missing `b`)                       |
