...
- Initial e2e tests completed and can be enabled by request.

#### Beta

- Gather and respond to feedback from developers and surveys.
- Existing testing suite is made more robust based on feedback.

#### GA

- Feature is battle-hardened and seen as essential by users of the [kube-storage-version-migrator].
