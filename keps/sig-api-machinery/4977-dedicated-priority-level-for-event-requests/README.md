...
# KEP-4977: Dedicated Priority Level For Event Requests
...
This KEP proposes creating a new priority level for Event requests in default
APF configuration for API Server to have better performance and reliability when
under pressure.
...
make use of APF for better performance and reliability of API Server. One thing
we have learned is that Event requests are plentiful in upscaling but they are
...
Read Verbs are excluded from this new flow schema because Administrators or
...
-   Feature implemented behind a feature flag
-   Manual upscaling tests to verify improvements
-   Ensure no negative impact in feature enable/disable

#### Beta

-   Ensure no negative impact in upgrade/downgrade
