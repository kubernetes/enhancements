...
Current HTTP Probe is not sufficent for check http status is correct or not. In some
...
Another is some stupid progame when it enconter a problem it will return 302 instead of 
another code.

There is also had some webprograme has it's owner healthy check page. It return success
...
- user can't judge the web service is work well or not through 
