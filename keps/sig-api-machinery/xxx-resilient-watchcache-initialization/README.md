# KEP-NNNN: Resilient watchcache initialization
...
that other clients should also properly support it.
...
setting any selectors (b) are setting a limit.
...
clients. To mitigate it, we will introduce all the logic behind a feature
