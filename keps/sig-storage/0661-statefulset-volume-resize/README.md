...
-->
Controller revision is a very useful functionality. As specified earlier in this doc, no changes will be made to the
Statefulset controller revision code. This will facilitate cases where statefulset has to roll back to a previous 
version with smaller requested storage size without the need to shrink the volume. Detailed documentation will be 
added to mitigate any user expectation mismatch.
