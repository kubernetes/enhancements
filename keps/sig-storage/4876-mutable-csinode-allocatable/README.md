...
- The use of the Kubernetes informer pattern in the scheduler. The
scheduler uses a `CSINode` informer and lister to efficiently access and watch `CSINode` objects.
