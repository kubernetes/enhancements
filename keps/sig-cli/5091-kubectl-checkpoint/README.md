...
environments is that users want to have them running for a very long time to be
able to come back to them whenever needed. To not block unused resources while
these containers are not used checkpointing enables the possibility to make a
