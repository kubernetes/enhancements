...
* applying a set of objects as an applyset but without pruning
* applying the same set of objects as an applyset and with pruning (no changes)
* applying a partially overlaping set of objects as an applyset but without pruning (no changes)
* applying a partially overlaping set of objects as an applyset but with dry-run pruning (no changes but differences reported)
* applying a partially overlaping set of objects as an applyset and with pruning (pruning operates as expected)
* applying the same set of partially overlaping objects as an applyset and with pruning (no changes)
