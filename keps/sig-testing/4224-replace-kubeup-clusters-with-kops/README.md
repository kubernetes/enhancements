...
The jobs will be available under the [sig-cluster-lifecycle-kubeup-to-kops](https://testgrid.k8s.io/sig-cluster-lifecycle-kubeup-to-kops) testgrid dashboard.
