...
to the appropiate location under `k8s.io/kubernetes/staging/src/k8s.io/e2e-framework`.
...
This will help maintainers of e2e tests have tools to easily test Kubernetes
any any component that run on Kubernetes.
This will also help external consumers of the e2e test framework by reducing
the ammount of dependency management they have to do now when importing the e2e
test framework.
