...
* NOT support pod level defaulting of sysctls, i.e. not support additional fildering on Pods to apply default sysctls.
...
Yes. To disable the feature, turn off the feature gate, or remove the kubelet config `DefaultPodSysctls`. The new pods will not have default sysctl settings, while existing pods keep unchanged.

###### What happens if we reenable the feature if it was previously rolled back?

The feature can be reenabled by setting the new sysctls, and new pods will have the new sysctl settings.
...
Yes, unit test will be added for the feature gate.
