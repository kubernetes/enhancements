...
rejected otherwise. E2e tests verify the scoring behavior with the option enabled
vs disabled.
...
This feature is not expected to impact any SLOs. If issues are observed, disable the
option and restart kubelet to rule it out.
