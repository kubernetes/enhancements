...
to modify the image volume contents in a non-persistent and pod isolated
environment. In the end it's ultimately up to the runtime to define the mounting
behavior depending on the underlying technologies being used.
