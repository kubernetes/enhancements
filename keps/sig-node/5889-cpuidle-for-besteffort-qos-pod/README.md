...
if the feature is enabled , operator can read /sys/fs/cgroup/kubepods.slice/kubepods-besteffort.slice/cpu.idle , 1 mean the feature is enabled ,0 mean it is disabled
<!--
