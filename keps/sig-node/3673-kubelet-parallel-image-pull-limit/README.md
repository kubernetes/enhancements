...
- [Motivation](#motivation)
  - [QPS/burst limits on kubelet are confusing](#qpsburst-limits-on-kubelet-are-confusing)
  - [No way to limit the number of inflight image pulls](#no-way-to-limit-the-number-of-inflight-image-pulls)
  - [Goals](#goals)
  - [Non-Goals](#non-goals)
- [Proposal](#proposal)
...
- [X] Other
  - Describe the mechanism: The feature will be enabled when the kubelet config field `maxParallelImagePulls` is set to a non-zero value on kubelet, can be disabled by setting `maxParallelImagePulls` to 0 and restarting kubelet.
