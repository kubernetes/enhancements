...
This proposal is integrated with and uses the [KEP-5328 (Node Declared Features framework)](https://github.com/pravk03/enhancements/tree/9de1ba74b4b71883f0ceabf8580d5d817bda36d4/keps/sig-node/5328-node-declared-features), to overcome feature rollout challenges with Version Skew, so additional to above conditions, the following condition is required to be satisfied:
...
const (
    InconsistentCPUAllocationError = "inconsistentCPUAllocationError"
    ProhibitedCPUAllocationError   = "prohibitedCPUAllocationError"
    GetPromisedCPUSetError         = "getPromisedCPUSetError"
)
```
