...
Introduce a new feature gate named RelaxedServiceNameValidation, which is disabled by default.
...
A rollback to a version that has the feature gate will work, even if there are
