...
As shown in the table, setting `actualPodHostname` will only change the hostname inside the pod and will not modify the DNS records in Kubernetes.
...
* Configure actualPodHostname via kube-apiserver:
