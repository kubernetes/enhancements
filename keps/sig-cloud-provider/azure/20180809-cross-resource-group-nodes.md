...
[LoadBalancer](https://github.com/kubernetes/cloud-provider/blob/master/cloud.go#L92) is not required for cross-RG nodes, hence only following features will be implemented for them:

- [Instances](https://github.com/kubernetes/cloud-provider/blob/master/cloud.go#L121)
- [Zones](https://github.com/kubernetes/cloud-provider/blob/master/cloud.go#L194)
- [Routes](https://github.com/kubernetes/cloud-provider/blob/master/cloud.go#L169)
...
To achieve this， [Informers](https://github.com/kubernetes/cloud-provider/blob/master/cloud.go#L52-L55) will be used to get node labels and then their RGs will be cached in `nodeResourceGroups map[string]string`.
