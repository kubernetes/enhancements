...
[LoadBalancer](https://github.com/kubernetes/cloud-provider/blob/master/cloud.go#L95) is not required for cross-RG nodes, hence only following features will be implemented for them:

- [Instances](https://github.com/kubernetes/cloud-provider/blob/master/cloud.go#L127)
- [Zones](https://github.com/kubernetes/cloud-provider/blob/master/cloud.go#L202)
- [Routes](https://github.com/kubernetes/cloud-provider/blob/master/cloud.go#L177)
...
To achieve this， [Informers](https://github.com/kubernetes/cloud-provider/blob/master/cloud.go#L64-L67) will be used to get node labels and then their RGs will be cached in `nodeResourceGroups map[string]string`.
