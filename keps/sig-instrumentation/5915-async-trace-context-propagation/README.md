...
<!-- toc -->
- [KEP-5915: Standardizing Async Trace Context Propagation](#kep-5915-standardizing-async-trace-context-propagation)
  ...
  - [Design Details](#design-details)
    ...
    - [Usage Examples](#usage-examples)
      ...
      - [Example 4: Scheduler Assigning Node ⚠️ Special Case](#example-4-scheduler-assigning-node-️-special-case)
    - [Test Plan](#test-plan)
  ...
  - [Production Readiness Review Questionnaire](#production-readiness-review-questionnaire)
    - [Feature Enablement and Rollback](#feature-enablement-and-rollback)
          ...
          - [Can the feature be disabled once it has been enabled (i.e. can it be rolled back)?](#can-the-feature-be-disabled-once-it-has-been-enabled-ie-can-it-be-rolled-back)
          - [What happens if the feature is reenabled after it was previously rolled back?](#what-happens-if-the-feature-is-reenabled-after-it-was-previously-rolled-back)
