...
As a platform engineering, I have a controller that composes Jobs but I want to
...
2. The `Workload` will define a `PodGroup` named "default" with a `MinCount` equal
...
- This KEP provides a cleaner integration point that external controllers can still
  leverage
