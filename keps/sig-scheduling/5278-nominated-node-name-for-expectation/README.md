...
- [Proposal](#proposal)
  - [User Stories (Optional)](#user-stories-optional)
    ...
    - [Story4: Kueue specifies <code>NominatedNodeName</code> to indicate where it prefers pods being scheduled to](#story4-kueue-specifies-nominatednodename-to-indicate-where-it-prefers-pods-being-scheduled-to)
...
- [Design Details](#design-details)
  ...
  - [The scheduler's cache for <code>NominatedNodeName</code>](#the-schedulers-cache-for-nominatednodename)
    - [The scheduler only modifies <code>NominatedNodeName</code>, not clears it in any cases](#the-scheduler-only-modifies-nominatednodename-not-clears-it-in-any-cases)
