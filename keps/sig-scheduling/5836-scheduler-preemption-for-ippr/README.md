...
- **Preemption Evaluation**:
  ...
  - Ensure that when a deferred resize fits without preemption, the pod is
    parked in `unschedulablePods` (waiting for Kubelet actuation) without
    triggering binding or victim preemption.
