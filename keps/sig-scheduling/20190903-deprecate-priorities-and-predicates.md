---
title: Deprecate Priorities and Predicates
authors:
  - "@draveness"
...
# Deprecate Priorities and Predicates
...
All the extension points of the scheduling framework have already been implemented, as the scheduling framework move to beta in 1.17 we should start the process of deprecating
the priorities and predicates function in the scheduler and replace them with the scheduling framework plugins.
