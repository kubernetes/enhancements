...
- [Motivation](#motivation)
  ...
  - [Existing Dashboard project](#existing-dashboard-project)
  - [Goals](#goals)
  - [Non-Goals](#non-goals)
- [Proposal](#proposal)
...
in-cluster user interface, both based on the [Headlamp](https://headlamp.dev)
project.
...
navigate between the projects. (Ex. Backstage plugin)
